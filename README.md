...
[4] Diao, M., Yang, L., Gong, W., Zhang, Y., Yan, Z., Han, Y., ... & Ma, Z. (2026). *Entropy-Adaptive Fine-Tuning: Resolving Confident Conflicts to Mitigate Forgetting.* [[arXiv]](https://arxiv.org/abs/2601.02151) <br>
[5] Li, Z., Chen, C., Xu, T., Qin, Z., Xiao, J., Luo, Z. Q., & Sun, R. *Preserving Diversity in Supervised Fine-Tuning of Large Language Models.* [[ICLR]](https://openreview.net/forum?id=NQEe7B7bSw) <br>
[6] Chen, Z., Li, G., Ai, T., Li, Y., Huang, Z., Zhou, W., ... & Ban, Y. (2026). Weak-Driven Learning: How Weak Agents make Strong Agents Stronger. [[arXiv]](https://arxiv.org/abs/2602.08222) <br>
